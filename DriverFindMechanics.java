 ...
 */
public class DriverFindMechanics extends Fragment implements RecyclerViewInterface {
     ...
     * @return A new instance of fragment DriverFindMechanics.
     */
    // TODO: Rename and change types and number of parameters
    public static DriverFindMechanics newInstance(String param1, String param2) {
        DriverFindMechanics fragment = new DriverFindMechanics();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_driver_find_mechanics, container, false);
        recyclerView=view.findViewById(R.id.myrecylerviewF);
    ...
    public void onItemClick(int position) {
        Intent intent = new Intent(getContext(), DriverSelectMechanic.class);
        ...
        intent.putExtra("garageName", mechanicsArrayList.get(position).getGarageName());
