...
public class MpesaMainActivity extends AppCompatActivity implements AuthListener, MpesaListener {
    //TODO: Replace these values from
    public static final String BUSINESS_SHORT_CODE = "174379";
    public static final String PASSKEY = "bfb279f9aa9bdbcf158e97dd71a467cd2e0c893059b10f78e6b72ada1ed2c919";
    public static final String CONSUMER_KEY = "ApQh1BbHq1RQGaK6XzuGkm7Zz5ZOcoSY";
    public static final String CONSUMER_SECRET = "KbaGUqNnjpRGTaS1";
    public static final String CALLBACK_URL = "http://mpesa-requestbin.herokuapp.com/1od2was1";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mpesa_main);
        pay = (Button)findViewById(R.id.pay);
        phone = (EditText)findViewById(R.id.phone);
        amount = (EditText)findViewById(R.id.amount);
        Mpesa.with(this, CONSUMER_KEY, CONSUMER_SECRET);
        dialog = new ProgressDialog(MpesaMainActivity.this);
