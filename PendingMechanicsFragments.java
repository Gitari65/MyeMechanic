 ...
 * Use the {@link PendingMechanicsFragments#newInstance} factory method to
 * create an instance of this fragment.
 */
public class PendingMechanicsFragments extends Fragment implements RecyclerViewInterface {
    ...
    public PendingMechanicsFragments() {
     ...
     * @return A new instance of fragment PendingMechanicsFragments.
     */
    // TODO: Rename and change types and number of parameters
    public static PendingMechanicsFragments newInstance(String param1, String param2) {
        PendingMechanicsFragments fragment = new PendingMechanicsFragments();
...
View view=inflater.inflate(R.layout.fragment_pending_mechanics_fragments, container, false);
    ...
    private void EventChangeListener() {
        ...
        db.collection("mechanics").whereEqualTo("registrationStatus", "pending").addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
